...
// Export functions to global scope to prevent lint errors
window.initializeFallback = initializeFallback;
window.saveConfigToStorage = saveConfigToStorage;
window.integrateWithChangeForm = integrateWithChangeForm;
