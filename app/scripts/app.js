...
// Export functions to global scope to prevent lint errorswindow.initializeFallback = initializeFallback;window.saveConfigToStorage = saveConfigToStorage;window.integrateWithChangeForm = integrateWithChangeForm;window.initializeApp = initializeApp;
